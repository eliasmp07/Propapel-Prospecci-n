...
fun UpdateReminderDialog(
    ...
    val date = convertLocalDate(state.dateNextReminder)
        ...
        content = {
            ElevatedCard(
                ...
                Column(
                    ...
                    Text(
                        modifier = Modifier.align(Alignment.CenterHorizontally),
                        text = "Ingresa los nuevos datos de la cita",
                    ...
                    ProSalesActionButtonOutline(
                        text = "Actualizar cita",
                        isLoading = state.isUpdateReminder,
                        onClick = {
                            focusManager.clearFocus()
                            onAction(DetailLeadAction.UpdateReminderClick)
                        }
                    )
                }
            }
